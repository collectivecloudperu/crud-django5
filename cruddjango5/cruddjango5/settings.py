"""
Django settings for cruddjango5 project.
...
SECRET_KEY = 'django-insecure-!u5u14*wgzextcy&l#hah1^b8calss-y(8pzn*4@592h8-4@v4'
...
WSGI_APPLICATION = 'cruddjango5.wsgi.application'
